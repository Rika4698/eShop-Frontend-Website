        ...
        <div className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-[100]">
                ...
                {isOpen && (
                    ...
                    {messages.length > 0 && (
                        ...
                        {messages.length == 0 && (      <button
                                ...
                                className="relative w-8 h-8 rounded-full flex items-center justify-center text-white hover:bg-white/15 transition-colors"
                                aria-label="Close"
                            >
                                <X className="w-4 h-4" />
                            </button>  )}
                                ...
                                >
                                    <div className="bg-red-50 text-red-600 px-3 py-2 text-xs border-b border-red-100 flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className="px-2 py-0.5 rounded text-xs hover:bg-red-100 transition-colors"
                                        >
                                            Dismiss
                                        </button>
                                    </div>
                        ...
                        <div
                            ref={scrollRef}
                            className="flex-1 overflow-y-auto px-4 py-4 space-y-4 bg-gray-50/60 overscroll-contain"
                        >
                            {/* Welcome Screen */}
            ...
            <motion.button
                ...
                className={cn(
                    ...
                    "shadow-[0_4px_24px_rgba(22,163,74,0.4)] transition-colors duration-200",
                    isLoading ? "bg-green-700" : error ? "bg-red-500" : "bg-green-600"
                )}
            >
                <AnimatePresence initial={false} mode="wait">
                    {isOpen ? (
                        <motion.span key="x" initial={{ rotate: -80, opacity: 0 }} animate={{ rotate: 0, opacity: 1 }} exit={{ rotate: 80, opacity: 0 }} transition={{ duration: 0.18 }} className="absolute flex items-center justify-center">
                            <X className="w-6 h-6 text-white" />
                        </motion.span>
                    ) : (
                        <motion.span key="msg" initial={{ rotate: 80, opacity: 0 }} animate={{ rotate: 0, opacity: 1 }} exit={{ rotate: -80, opacity: 0 }} transition={{ duration: 0.18 }} className="absolute flex items-center justify-center">
                            {isLoading
