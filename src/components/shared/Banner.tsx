          ...
          <div className="relative w-full xl:h-[450px] lg:h-[355px] md:h-[290px] h-[320px] rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="absolute inset-0 flex flex-col justify-center pl-[30px] md:pl-[60px] text-white">
              ...
              <h1 className="text-[28px] md:text-[40px] xl:text-[55px] font-bold leading-tight md:w-[520px] mb-4">
                Fresh Groceries <br />
                <span className="text-[#7ed321]">Delivered Daily</span>
              </h1>
              
              <p className="text-base md:text-lg mb-2 text-gray-200">
                Save up to <span className="text-[#7ed321] font-bold text-2xl md:text-3xl">40% OFF</span>
              </p>
              
              <p className="text-sm md:text-base text-gray-300 mb-6">
                100% organic and farm fresh products
              </p>
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-4 md:gap-5 mt-4 md:mt-5">
        ...
        <div className="group">
          <div className="relative w-full lg:h-[260px] md:h-[220px] h-[240px] rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-pink-900/80 via-pink-900/50 to-transparent"></div>
            
            <div className="absolute inset-0 flex items-center justify-start pl-8 md:pl-12">
              <div>
                <span className="text-xs md:text-sm text-pink-300 font-semibold uppercase tracking-wide">
                  New Arrivals
                </span>
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-white my-2">
                  Fashion Trends
                </h3>
                <p className="text-sm md:text-base text-pink-100 mb-4">
                  Up to <span className="text-yellow-300 font-bold text-lg">50% OFF</span>
                </p>
                <Link href="/all-products">
                  <button className="bg-pink-500 hover:bg-pink-600 transition-colors text-white rounded-lg px-5 md:px-6 py-2 text-sm md:text-base font-semibold shadow-md hover:shadow-lg">
                    Shop Fashion
                  </button>
                </Link>
              </div>
