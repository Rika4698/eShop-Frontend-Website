    ...
    <section className="py-8 sm:py-12 md:py-16  max-w-7xl mx-auto">
      ...
      <Link href="/flashSale" className="block lg:hidden mt-8">
        <div className="flex justify-center">
          <button onClick={scrollToTop} className="group relative overflow-hidden w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-[#18b500] via-[#48ad39] to-[#80b500] text-white font-bold text-sm sm:text-base uppercase rounded-full shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
