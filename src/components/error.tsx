...
//             <div className="lg:px-2 md:px-0 overflow-hidden py-2 lg:py-0 relative">
...
//                                             <Image
//                                                 src="/logo.png"
//                                                 className="md:w-[72px] w-[50px] pt-2 hidden md:block"
//                                                 width={170}
//                                                 height={50}
//                                                 alt="logo"
//                                             />
...
//                                                 E
//                                                 <span className="md:text-2xl text-[16px] text-green-500">
//                                                     Shop
//                                                 </span>
//                                             </h2>
...
//                                             <div className="absolute right-0 cursor-pointer top-0 bg-[#80b500] px-6 py-3 rounded-r-md">
...
//                                                     className="bg-[#170f0d] w-[40px] relative h-[40px] flex justify-center items-center rounded-full cursor-pointer"
//                                                 >
//                                                     <FaArrowRightArrowLeft className="text-[21px] text-gray-500 font-bold" />
//                                                     <span className="bg-[#7fad39] top-[-2px] right-[-3px] absolute w-[18px] h-[18px] flex justify-center items-center rounded-full text-white text-xs">
//                                                         0
//                                                     </span>
//                                                 </div>
//                                             </div>
...
//                                                 <div
//                                                     title="My Cart"
//                                                     className="bg-[#fff1ee] w-[40px] relative h-[40px] flex justify-center items-center rounded-full cursor-pointer"
//                                                 >
//                                                     <Image
...
//                 {/* Search Results Dropdown - Outside the border-b container */}
